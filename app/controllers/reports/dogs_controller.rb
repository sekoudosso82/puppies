class Reports::DogsController < ApplicationController 
    ...
    #     # byebug
    #     if @dog.valid? 
    #         redirect_to reports_owner_path(@dog.owner.id) 
    #     else
    #         flash[:errors] = @dog.errors.full_messages 
    #         redirect_to  new_reports_owner_dog_path() 
    #     end  
    # end 
    ...
    #     else
    #         flash[:errors] = @dog.errors.full_messages 
    #         redirect_to edit_reports_owner_dog_path(@dog) 
    #     end  
    # end 
  
    # def destroy 
    #     @dog.destroy 
    #     redirect_to reports_owner_path(params[:owner_id])
    # end 
